...
def main(page: ft.Page):
    ...
    campo_nome = ft.TextField(
        label="Digite seu nome aqui", # Texto que aparece acima do campo
        width=300, # Largura do campo
        border_color=ft.Colors.BLUE # Cor da borda do campo
    )
    ...
    def processar_nome(evento):
        """
        Esta função pega o texto digitado no campo e o exibe na tela.
        """
